...
let
  ...
  src = fetchurl {
    url = "https://github.com/captaindonald/tonic/releases/download/${version}/Tonic-${version}-linux-amd64.deb";
    hash = "sha256-yWlc+uBLau1yhWAiYlWhBN+E7IlSRzj/i3KE425qCMI=";
  };
